...
p2=semilogy(freq,bound_whtc,'linewidth',lw,'color',cbound,'displayname','MgF2');
p1=semilogy(freq,optimal_whtc,'linewidth',lw,'color',coptimal,'displayname','LST-constrained optimal');
hold on
set(gca, 'YScale', 'log')
xlim([0.01,0.2])
